...
class OrganismesControllerTest < ActionController::TestCase
  ...
  test "should create organisme" do
    assert_difference('Organisme.count') do
      post :create, organisme: { adresse: @organisme.adresse, nom: @organisme.nom, telephone: @organisme.telephone }
    end
  ...
  test "should update organisme" do
    patch :update, id: @organisme, organisme: { adresse: @organisme.adresse, nom: @organisme.nom, telephone: @organisme.telephone }
    assert_redirected_to organisme_path(assigns(:organisme))
  end
