...
class EntreprisesControllerTest < ActionController::TestCase
  ...
  test "should create entreprise" do
    assert_difference('Entreprise.count') do
      post :create, entreprise: { adresse: @entreprise.adresse, nom: @entreprise.nom, telephone: @entreprise.telephone }
    end
  ...
  test "should update entreprise" do
    patch :update, id: @entreprise, entreprise: { adresse: @entreprise.adresse, nom: @entreprise.nom, telephone: @entreprise.telephone }
    assert_redirected_to entreprise_path(assigns(:entreprise))
  end
